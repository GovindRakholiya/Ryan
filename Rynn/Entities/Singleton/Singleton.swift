...
class Singleton: NSObject {
    ...
    var is_Task_Inside = false
    var is_Notes_edit = false
    var is_LocationVisible = false
    var is_BookingVisible = false
    var selectedIndexOfMenu = IndexPath(row: 0, section: 0)
    
    
    var sideMenuFrom : String = Global.navigation_for._Home
    ...
    func showTostAlert(withMsg message: String) {
        ...
        Global.appDelegate.window?.rootViewController?.view.makeToast(message, duration: 3.0, position: .bottom)
    }
    ...
    func setCornerRadius(viewfor : UIView,cornerRadius : Float, borderColor : UIColor? , borderwidth : Float?
        )  {
        viewfor.layer.cornerRadius = CGFloat(cornerRadius)
        if (borderwidth != nil)
        {
            viewfor.layer.borderWidth = CGFloat(borderwidth!)
        }
        if (borderColor != nil)
        {
            viewfor.layer.borderColor = borderColor as! CGColor
        }
    ...
    func drawViewBorder(viewForDraw : UIView, radius : Float, width : Float, color : UIColor)  {
        
        viewForDraw.layer.borderWidth = CGFloat(width)
        viewForDraw.layer.cornerRadius = CGFloat(radius)
        viewForDraw.layer.borderColor = color.cgColor
    }
    ...
    func setBorder(view : UIView,borderwidth : CGFloat,cornerradius : CGFloat,borderColer : CGColor) {
            view.layer.borderWidth = borderwidth
        view.layer.cornerRadius = cornerradius
        view.layer.borderColor = borderColer
        view.clipsToBounds = true
    }
    ...
    func showDropDown(dropdown : DropDown,anchorView : UIView,dataSource : [String]) {
...
//    }
    ...
    func parseLoginUserData(dic:NSDictionary) -> Void {        
        ...
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"email") as? String ?? "" , forKey: Global.kLoggedInUserKey.Email)
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"firstname") as? String ?? "" , forKey: Global.kLoggedInUserKey.FirstName)
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"lastname") as? String ?? "" , forKey: Global.kLoggedInUserKey.LastName)
        
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"zipcode") as? String ?? "" , forKey: Global.kLoggedInUserKey.zipCode)
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"images_thum") as? String ?? "" , forKey: Global.kLoggedInUserKey.user_ThumbImage)
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"document_status") as? String ?? "" , forKey: Global.kLoggedInUserKey.documentStatus)
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"current_longitude") as? String ?? "" , forKey: Global.kLoggedInUserKey.longitude)
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"current_lattitude") as? String ?? "" , forKey: Global.kLoggedInUserKey.latitude)
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"current_address") as? String ?? "" , forKey: Global.kLoggedInUserKey.address)
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"Is_delivery") as? String ?? "" , forKey: Global.kLoggedInUserKey.is_delivered)
        Singleton.sharedSingleton.saveToUserDefaults(value: dic.object(forKey:"phone") as? String ?? "" , forKey: Global.kLoggedInUserKey.phone)
    ...
    func addShowLoaderInView(viewObj: UIView, boolShow: Bool, enableInteraction: Bool) -> UIView? {
        ...
        rtSpinKitspinner.color = Global.kAppColor.PrimaryBlack
